...
<head>
  ...
  <link href="<?php echo e(url("https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css")); ?>" rel="stylesheet">
...
<body>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="/list-logo" class="menu-link">
                  <div data-i18n="Without menu">View Post</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="/add-logo" class="menu-link">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="/list/news/" class="menu-link">
                  <div data-i18n="Without menu">View Post</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="/add/news/" class="menu-link">
                  <div data-i18n="Without menu">Add Post</div>
                </a>
              </li>
            </ul>
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="<?php echo e(asset('image/' . Auth::user()->profile)); ?>" alt class="w-px-40 h-auto rounded-circle" />
                    <!-- <?php dump(Auth::user()->profile); ?> -->
                  </div>
                </a>
  ...
  <!-- Page JS -->
  <script src="<?php echo e(url('./js/form-basic-inputs.js')); ?>"></script>

  <!-- Place this tag in your head or just before your close body tag. -->
  <script async defer src="<?php echo e(url('https://buttons.github.io/buttons.js')); ?>"></script>

  <!-- SWAL -->
  <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js')); ?>" integrity="sha512-AA1Bzp5Q0K1KanKKmvN/4d3IRKVlv9PYgwFPvm32nPO6QS8yH1HO7LbgB1pgiOxPtfeg5zEn2ba64MUcqJx6CA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
</html><?php /**PATH D:\Laravel\laravel-Shopping\resources\views/dashboard/master.blade.php ENDPATH**/ ?>